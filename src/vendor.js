/*
  ...
  as the application's code. So all the libraries we references
  ...
  a vendor library changes which shoukd be less frequent.
  Any files that aren't referenced here will be boundled into
